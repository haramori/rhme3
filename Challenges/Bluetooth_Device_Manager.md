...
The following was accomplished using the hardware debugging configuration described in the [Debugging AVR XMEGA raw binaries](../Preparation/Debugging AVR XMEGA raw binaries.md) guide.
